    ...
    <Accordion className={shiny ? ("shine-effect-button") : ""} onClick={() => { setShiny(!shiny) }}>
      ...
      >
        <Grid container sx={{ display: "flex", justifyContent: "space-evenly" }}>
          <Grid item xs={2}>
             < img loading="lazy"src={bluemary} alt={bluemary} width="110px" height="150px" />
          </Grid>

          <Grid item xs={10} sx={{ display: "flex", justifyContent: "left", alignItems: "flex-end" }}>
            <Typography variant="h2" mb={2} sx={{ color: "white", textShadow: "2px 2px black" }}>BLUE MARY</Typography>
          </Grid>
        </Grid>
      </AccordionSummary>
      <CommandMoves />
      <AfterMove move=" HAMMER ARCH" />
      <InputBar>
        <Press icon={right} />
        <Plus />
        <Press icon={punchLow} />
      </InputBar>
      <AfterMove move=" DOUBLE ROLLING" />
      <InputBar>
        <Press icon={left} />
        <Plus />
        <Press icon={kickLow} />
      </InputBar>
      <AfterMove move=" CLIMBING ARROW" />
      <InputBar>
      ...
      <SpecialMoves />
      <AfterMove move=" STRAIGHT SLICER [EX]" />
      <InputBar>
        <Charge />
        <Press icon={left} />
        <Press icon={right} />
      ...
      <AfterMove move="CRAB CLUTCH" />
      <InputBar> [
        <Press icon={kickHigh} /> STRAIGHT SLICER]
        <Press icon={hadoken} />
        <Plus />
        <Press icon={kickLow} />
        <Or />
      ...
      <AfterMove move=" STUN FANG" />
      <InputBar>
        <AfterMove move=" [ [EX] STRAIGHT SLICER]" />
        <Press icon={hadoken} />
        <Plus />
        <Press icon={punchLow} />
        <Or />
      ...
      <AfterMove move=" VERTICAL ARROW [EX]" />
      <InputBar>
        <Press icon={shory} />
        <Plus />
        <Press icon={kickLow} />
      ...
      <AfterMove move=" M. SNATCHER" />
      <InputBar> [
        <Press icon={kickHigh} /> VERTICAL ARROW]
        <Press icon={shory} />
        <Plus />
        <Press icon={kickLow} />
        <Or />
      ...
      <AfterMove move=" M.SPIDER" />
      <InputBar> [
        <Press icon={punchHigh} /> SPIN FALL]
        <Press icon={hadoken} />
        <Plus />
        <Press icon={punchLow} />
        <Or />
      ...
      <AfterMove move=" REAL COUNTER [EX]" />
      <InputBar>
      ...
      <AfterMove move=" BACKDROP REAL" />
      <InputBar> [CLOSE BY · REAL COUNTER]
        <Press icon={hadoken} />
        <Plus />
        <Press icon={punchLow} />
        <Or />
      ...
      <AfterMove move=" M.SPLASH ROSE [MAX]" />
      <InputBar>
        <Press icon={hadoken} />
        <Press icon={halfCircleBack} />
        <Plus />
      ...
      <ClimaxSuperSpecialMoves />
      <AfterMove move=" M. DYNAMITE SWING" />
      <InputBar>
        <Press icon={reverseHadoken} />
