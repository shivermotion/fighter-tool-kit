...
import meitenkun from "../../../assets/game-logos/kof/fighters_index_02.png"
    ...
    <Accordion className={shiny ? ("shine-effect-button") : ""} onClick={() => { setShiny(!shiny) }}>
      ...
      >
        <Grid container sx={{ display: "flex", justifyContent: "space-evenly" }}>
          <Grid item xs={2}>
            <img loading="lazy" src={meitenkun} alt={meitenkun} width="110px" height="150px" />
          </Grid>
