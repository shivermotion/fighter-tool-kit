...
import kod from "../../../assets/game-logos/kof/fighters_index_25.png"
    ...
    <Accordion className={shiny ? ("shine-effect-button") : ""} onClick={() => { setShiny(!shiny) }}>
      ...
      >
        <Grid container sx={{ display: "flex", justifyContent: "space-evenly" }}>
          <Grid item xs={2}>
             < img loading="lazy"src={kod} alt={kod} width="110px" height="150px" />
          </Grid>
      ...
      <SuperSpecialMoves />
      <MoveName
        move=" SUPER ZETSUMETSU HURRICANE [MAX]
      "
      />
      <InputBar>
        <InAir />
