...
import joe from "../../../assets/game-logos/kof/fighters_index_05.png"
    ...
    <Accordion className={shiny ? ("shine-effect-button") : ""} onClick={() => { setShiny(!shiny) }}>
      ...
      >
        <Grid container sx={{ display: "flex", justifyContent: "space-evenly" }}>
          <Grid item xs={2}>
             < img loading="lazy"src={joe} alt={joe} width="110px" height="150px" />
          </Grid>
      ...
      <MoveName
        move=" BAKU-SLA GOLDEN TIGER [MAX]
      "
      />
      <InputBar>
        <Press icon={hadoken} />
